...
var MentionsInput = _react2.default.createClass({
  ...
  renderControl: function renderControl() {
    ...
    console.log('mentions.render.input', inputProps.name, inputProps.value, { singleLine: singleLine, inputProps: inputProps, controlProps: (0, _extends4.default)({}, controlProps), props: this.props });
    return _react2.default.createElement(
      'div',
      controlProps,
  ...
  getPlainText: function getPlainText() {
    return _utils2.default.getPlainText(
    // use cached value to avoid rerender with old value on local state update
    this.state.value || this.props.value || "", this.props.markup, this.props.displayTransform);
  },
  ...
  handleChange: function handleChange(ev) {
    ...
    console.log('mentions.change', [value, newValue], [_utils2.default.getPlainText(value, this.props.markup, this.props.displayTransform), ev.target.value, newPlainTextValue], [this.state.selectionStart, this.state.selectionEnd, this.state.setSelectionAfterMentionChange], [ev.target.selectionStart, ev.target.selectionEnd], [startOfMention, startOfMention !== undefined && this.state.selectionEnd > startOfMention], [selectionStart, selectionEnd, setSelectionAfterMentionChange], {
      state: (0, _clone2.default)(this.state),
      props: this.props
    });
