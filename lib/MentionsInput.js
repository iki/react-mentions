...
var MentionsInput = _react2.default.createClass({
  ...
  getCurrentValue: function getCurrentValue() {
    ...
    var usedValue = (value && value === this.state.lastPropValue ? this.state.value : value) || '';
  ...
  renderSuggestionsOverlay: function renderSuggestionsOverlay() {
    ...
    style = (0, _extends4.default)({}, suggestionsPosition, style);
  ...
  handleChange: function handleChange(ev) {
    ...
    this.executeOnChange(eventMock, { newValue: newValue, newPlainTextValue: newPlainTextValue, mentions: mentions, input: this.refs.input });
  },
