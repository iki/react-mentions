...
var SuggestionsOverlay = function (_Component) {
  ...
  (0, _createClass3.default)(SuggestionsOverlay, [{
    ...
    value: function componentDidUpdate() {
      ...
      var focused = suggestions && suggestions.children[this.props.focusIndex];
      var container = suggestions && suggestions.offsetParent;
      ...
      var rectFocused = focused.getBoundingClientRect();
      var rectContainer = container.getBoundingClientRect();
      var overscan = rectFocused.height * 0.618;
      var scrollTopMax = scrollTop + rectFocused.top - rectContainer.top - overscan;
      var scrollTopMin = scrollTop + rectFocused.bottom - rectContainer.top - offsetHeight + overscan;
