...
var Suggestion = function (_Component) {
  ...
  (0, _createClass3.default)(Suggestion, [{
    ...
    value: function renderContent() {
      ...
      if (descriptor.props.highlightSearch) {
        display = this.renderHighlightedDisplay(display, query);
      }

      if (descriptor.props.renderSuggestion) {
        var renderHighlighted = function renderHighlighted(text) {
          return _this2.renderHighlightedDisplay(text, query);
        };
